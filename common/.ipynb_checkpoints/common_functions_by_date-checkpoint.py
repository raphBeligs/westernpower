...
class BatteryPowerDispatcher:
    ...
    def get_solar_energy_proportion_by_day_in_a_week(self,df,start_date, charge_method=1,max_battery_charge_in_week=[6,6,6,6,6,6,6]):
    ...
    def get_all_dispatch_in_a_week(self,df, start_date, charge_method=1,full_solar=False):
        if full_solar:
